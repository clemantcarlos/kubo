...
// HOOKS
import useSupplier from "../supplier/hooks/useSupplierTable";
// TABLE
import { flexRender } from "@tanstack/react-table";
import { columns } from "../supplier/components/supplier-columns";

export default function Supplier() {
  const { table, handleInputChange, pageParam, setPageParam, totalPages } = useSupplier();
  return (
    <div className="container mx-auto p-10">
      <div className="flex items-center justify-between py-4 gap-4">
        <Input
          ...
          className="max-w-sm"
        />
        <SupplierDialog actionType="create" />
      </div>
